...
async function ensureSchema(env) {
  await env.MARKET_DB.batch([
    ...
    env.MARKET_DB.prepare(`CREATE TABLE IF NOT EXISTS market_context_probe_game_odds (game_odds_row_id TEXT PRIMARY KEY, batch_id TEXT, slate_window_key TEXT, official_date TEXT, game_pk INTEGER, source_event_id TEXT, home_team TEXT, away_team TEXT, commence_time_utc TEXT, bookmaker_key TEXT, market_key TEXT, outcome_name TEXT, line_point REAL, price_american REAL, price_decimal REAL, raw_json TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP)`),
