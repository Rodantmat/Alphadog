...
- Phase 4 (work the 7 workers one by one: revise for new Board, wire to tally, build derived fallback per layer, verify downstream contract fields): starting next.
