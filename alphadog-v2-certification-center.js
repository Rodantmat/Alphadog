...
const VERSION = "alphadog-v2-certification-center-v0.2.3-global-error-handler";
const JOB_KEY = "main-ui-board-viewer";

const REQUIRED_DB_BINDINGS = ["CONTROL_DB", "CONFIG_DB", "REF_DB", "STATS_HITTER_DB", "STATS_PITCHER_DB", "TEAM_DB", "DAILY_DB", "MARKET_DB", "CONTEXT_DB", "SCORE_DB"];
...
const DOCUMENTED_PROP_OPTIONS = [
  ...
  { prop_family: "hitter", canonical_prop_key: "hits_runs_rbis", label: "Hits + Runs + RBIs" },
  { prop_family: "hitter", canonical_prop_key: "total_bases", label: "Total Bases" },
  { prop_family: "hitter", canonical_prop_key: "runs", label: "Runs" },
  { prop_family: "hitter", canonical_prop_key: "rbis", label: "RBIs" },
  { prop_family: "hitter", canonical_prop_key: "singles", label: "Singles" },
  { prop_family: "hitter", canonical_prop_key: "doubles", label: "Doubles" },
  { prop_family: "hitter", canonical_prop_key: "triples", label: "Triples" },
  { prop_family: "hitter", canonical_prop_key: "home_runs", label: "Home Runs" },
  { prop_family: "hitter", canonical_prop_key: "walks", label: "Walks" },
  { prop_family: "hitter", canonical_prop_key: "hitter_strikeouts", label: "Hitter Strikeouts" },
  { prop_family: "hitter", canonical_prop_key: "fantasy_score", label: "Fantasy Score" },
  { prop_family: "hitter", canonical_prop_key: "stolen_bases", label: "Stolen Bases" },
  { prop_family: "pitcher", canonical_prop_key: "pitcher_strikeouts", label: "Pitcher Strikeouts" },
  { prop_family: "pitcher", canonical_prop_key: "pitcher_outs", label: "Pitching Outs" },
  { prop_family: "pitcher", canonical_prop_key: "earned_runs", label: "Earned Runs Allowed" },
  { prop_family: "pitcher", canonical_prop_key: "hits_allowed", label: "Hits Allowed" },
  { prop_family: "pitcher", canonical_prop_key: "walks_allowed", label: "Walks Allowed" },
  { prop_family: "pitcher", canonical_prop_key: "runs_allowed", label: "Runs Allowed" },
  { prop_family: "pitcher", canonical_prop_key: "rfi_nrfi", label: "RFI / NRFI" }
];

const DOCUMENTED_SOURCE_LINE_OPTIONS = [
  { source_key: "prizepicks", line_type: "goblin", label: "Goblin" },
  { source_key: "prizepicks", line_type: "demon", label: "Demon" },
  { source_key: "prizepicks", line_type: "regular", label: "Regular" },
  { source_key: "sleeper", line_type: "regular", label: "Regular" },
  { source_key: "sleeper", line_type: "more_only", label: "More Only" }
];

const LOGO_PNG_BASE64 = "";
...
function baseIdentity(env) {
  ...
  return {
    ...
    job_key: JOB_KEY,
    status: "MAIN_UI_READY_READ_ONLY",
    timestamp_utc: nowUtc(),
    read_only: true,
    writes_performed: 0,
    external_calls_performed: 0,
    queue_calls_performed: 0,
    notes: [
      "Repurposed existing certification-center dummy slot as Main UI board viewer.",
      "Read-only: no DB writes, no queue enqueue, no orchestrator calls, no external calls.",
      "Rows are Review Board candidates for neutral display; live_playable_rows is currently reported separately."
    ],
    binding_summary: {
      required_db_bindings_present: allTrue(db),
      expected_vars_present: allTrue(vars),
      required_secrets_present: allTrue(secrets),
      score_db_present: Boolean(env && env.SCORE_DB)
    }
  };
}
...
function uiFinite(v, d = null) {
  const n = Number(v);
  return Number.isFinite(n) ? n : d;
}
function uiText(v) { return String(v == null ? "" : v).trim(); }
function uiFirstReal(values) {
...
function uiHashPick(seed, arr) {
  if (!arr || !arr.length) return "";
  let h = 2166136261;
  for (const ch of String(seed || "")) { h ^= ch.charCodeAt(0); h = Math.imul(h, 16777619); }
  return arr[(h >>> 0) % arr.length];
}
function uiOrdinal(n) {
  const x = Math.trunc(uiFinite(n, 0));
  if (!x) return "";
  const s = ["th","st","nd","rd"], v = x % 100;
  return x + (s[(v - 20) % 10] || s[v] || s[0]);
}
function uiPitcherLabel(row) {
  const name = uiFirstReal([row.opposing_pitcher_name, row.probable_pitcher_name]);
  const hand = uiFirstReal([row.opposing_pitcher_hand, row.probable_pitcher_hand]);
  if (!name) return "";
  return name + (hand ? ` (${hand})` : "");
}
function uiMetricBits(row) {
  const bits = [];
  ...
  if (era != null) bits.push(`ERA ${era.toFixed(2)}`);
  if (whip != null) bits.push(`WHIP ${whip.toFixed(2)}`);
  if (fip != null) bits.push(`FIP ${fip.toFixed(2)}`);
  if (k9 != null) bits.push(`${k9.toFixed(1)} K/9`);
  if (bb9 != null) bits.push(`${bb9.toFixed(1)} BB/9`);
  return bits;
}
...
function uiPitcherSentence(row) {
  ...
  const hand = uiFirstReal([row.opposing_pitcher_hand, row.probable_pitcher_hand]).toLowerCase();
...
function rowToApi(row) {
  ...
  return {
    final_board_row_id: row.final_board_row_id,
    final_board_batch_id: row.final_board_batch_id,
    hp_board_batch_id: row.hp_board_batch_id,
    source_hp_batch_id: row.source_hp_batch_id,
    ...
    prop_label: displayPropLabel(row.canonical_prop_key),
    prop_family: row.prop_family,
    line_value: row.line_value,
    selected_side: row.selected_side,
    score_0_100: row.score_0_100,
    confidence_0_100: row.confidence_0_100,
    score_grade: row.score_grade,
    score_sort_0_100: row.score_sort_0_100,
    side_mode: row.side_mode,
    odds_type: row.odds_type,
    payout_variant: row.payout_variant,
    line_type: lineType,
    line_type_label: displayLineTypeLabel(lineType, row.source_key),
    app_line_label: `${displaySourceLabel(row.source_key)} • ${displayLineTypeLabel(lineType, row.source_key)}`,
    source_line_type: row.source_line_type,
    projection_type: row.projection_type,
    is_goblin: Number(row.is_goblin || 0),
    is_demon: Number(row.is_demon || 0),
    is_standard: Number(row.is_standard || 0),
    board_tier: row.board_tier,
    default_board_rank: row.default_board_rank,
    raw_rank_order: row.raw_rank_order,
    default_board_visible: Number(row.default_board_visible || 0),
    default_suppression_reason: row.default_suppression_reason,
    player_game_rank: row.player_game_rank,
    player_game_total_legs: row.player_game_total_legs,
    player_prop_rank: row.player_prop_rank,
    correlation_cluster: row.correlation_cluster,
    sanity_confidence_0_100: row.sanity_confidence_0_100,
    trust_readiness_score_0_100: row.trust_readiness_score_0_100,
    overall_score_0_100: row.overall_score_0_100,
    certainty_0_100: row.certainty_0_100,
    hit_probability_0_100: row.hit_probability_0_100,
    warning_count: row.warning_count,
    partial_context_count: row.partial_context_count,
    missing_component_count: row.missing_component_count,
    source_final_score_batch_id: row.source_final_score_batch_id,
    source_hp_v2_batch_id: row.source_hp_v2_batch_id,
    source_score_enrichment_batch_id: row.source_score_enrichment_batch_id,
    review_playable: Number(row.review_playable || 0),
    live_playable: Number(row.live_playable || 0),
    estimated_hit_probability_0_100: row.estimated_hit_probability_0_100,
    probability_confidence_0_100: row.probability_confidence_0_100,
    probability_band: row.probability_band,
    probability_grade: row.probability_grade,
    hp_lane: row.hp_lane,
    hp_rank: row.hp_rank,
    hp_sort_0_100: row.hp_sort_0_100,
    hp_source_lane_reason: row.hp_source_lane_reason,
    factor_status: row.factor_status,
    market_prop_context_status: row.market_prop_context_status,
    daily_readiness_status: row.daily_readiness_status,
    ...
    opposing_pitcher_era: row.opposing_pitcher_era,
    opposing_pitcher_whip: row.opposing_pitcher_whip,
    opposing_pitcher_fip: row.opposing_pitcher_fip,
    opposing_pitcher_k9: row.opposing_pitcher_k9,
    opposing_pitcher_bb9: row.opposing_pitcher_bb9,
    lineup_status: row.lineup_status,
    batting_order: row.batting_order,
    weather_summary: row.weather_summary,
    weather_temp_f: row.weather_temp_f,
    wind_summary: row.wind_summary,
    roof_status: row.roof_status,
    umpire_name: row.umpire_name,
    umpire_context_summary: row.umpire_context_summary,
    bullpen_context_summary: row.bullpen_context_summary,
    schedule_context_summary: row.schedule_context_summary,
    ...
    leg_insight_comment: composeLegInsight(row),
...
function buildCurrentSql(url) {
  ...
  const sourceKeys = splitList(url.searchParams.get("source_keys"));
  const lineTypes = splitList(url.searchParams.get("line_types"));
  const selectedSides = splitList(url.searchParams.get("selected_sides"));
  const boardTiers = splitList(url.searchParams.get("board_tiers"));
  ...
  if (propFamilies.length) {
    ...
    for (const fam of propFamilies.map(v => String(v).toLowerCase())) {
      if (fam === "pitcher") clauses.push("(f.canonical_prop_key LIKE 'pitcher_%' OR f.canonical_prop_key IN ('earned_runs','hits_allowed','walks_allowed','pitcher_outs','runs_allowed','rfi_nrfi'))");
      else if (fam === "hitter") clauses.push("(f.canonical_prop_key NOT LIKE 'pitcher_%' AND f.canonical_prop_key NOT IN ('earned_runs','hits_allowed','walks_allowed','pitcher_outs','runs_allowed','rfi_nrfi'))");
    }
  ...
  const baseSelect = `
      ...
      f.rank_order AS default_board_rank,
      1 AS default_board_visible,
      NULL AS default_suppression_reason,
      NULL AS player_game_rank,
      NULL AS player_game_total_legs,
      NULL AS player_prop_rank,
      NULL AS correlation_cluster,
      f.source_key,
      f.game_pk,
      f.official_date,
      ...
      f.review_playable,
      f.live_playable,
      f.estimated_hit_probability_0_100 AS estimated_hit_probability_0_100,
      f.confidence_0_100 AS probability_confidence_0_100,
      CASE WHEN f.estimated_hit_probability_0_100 >= 80 THEN '80+' WHEN f.estimated_hit_probability_0_100 >= 70 THEN '70+' WHEN f.estimated_hit_probability_0_100 >= 60 THEN '60+' ELSE '<60' END AS probability_band,
      CASE WHEN f.estimated_hit_probability_0_100 >= 80 THEN 'A' WHEN f.estimated_hit_probability_0_100 >= 70 THEN 'B' WHEN f.estimated_hit_probability_0_100 >= 60 THEN 'C' ELSE 'LOW' END AS probability_grade,
      f.board_tier AS hp_lane,
      f.rank_order AS hp_rank,
      f.estimated_hit_probability_0_100 AS hp_sort_0_100,
      f.score_grade AS hp_source_lane_reason,
      f.score_grade AS factor_status,
      'current' AS market_prop_context_status,
      f.score_grade AS daily_readiness_status,
      CASE WHEN f.canonical_prop_key LIKE 'pitcher_%' OR f.canonical_prop_key IN ('earned_runs','hits_allowed','walks_allowed','pitcher_outs','runs_allowed','rfi_nrfi') THEN 'pitcher' ELSE 'hitter' END AS prop_family,
      ...
      f.confidence_0_100 / 100.0 AS hp_reliability_0_1,
      f.confidence_0_100 AS hp_sample_reliability_score_0_100,
      NULL AS hp_display_notes_preview,
      NULL AS sanity_confidence_0_100,
      f.confidence_0_100 AS trust_readiness_score_0_100,
...
function dossierRowToApi(row) {
  const api = rowToApi({
    ...row,
    hp_display_notes_preview: row.hp_display_notes_json ? String(row.hp_display_notes_json).slice(0, 1200) : row.hp_display_notes_preview
  });
  return api;
}
async function apiDossier(env, url) {
  ...
  function propValueFromGameRow(prop, r) {
    ...
    if (p === "rfi_nrfi") return r.first_frame_runs_allowed != null ? Number(r.first_frame_runs_allowed) : null;
    return null;
  }
  ...
  const battedBallDirD = !isPitcher ? (await safeQuery(`SELECT fly_ball_pct, line_drive_pct, ground_ball_pct, pop_up_pct, pull_pct, opposite_field_pct, batted_ball_events FROM ref.batted_ball_profile WHERE mlb_player_id=? ORDER BY season_year DESC LIMIT 1`, [mlbPlayerId]))[0] || null : null;
  const hrSumRowD = !isPitcher ? (await safeQuery(`SELECT home_runs_sum FROM stats_hitter.metric_snapshots WHERE player_id=? AND metric_window='season_to_date'`, [mlbPlayerId]))[0] || null : null;
  if (qocRowD && battedBallDirD) Object.assign(qocRowD, battedBallDirD);
  if (qocRowD && battedBallDirD && hrSumRowD && Number(battedBallDirD.batted_ball_events) > 0 && battedBallDirD.fly_ball_pct != null) {
    const flyBallCount = (Number(battedBallDirD.fly_ball_pct) / 100) * Number(battedBallDirD.batted_ball_events);
    qocRowD.hr_fb_percent = flyBallCount > 0 ? Math.round(((Number(hrSumRowD.home_runs_sum) || 0) / flyBallCount) * 1000) / 10 : null;
  }
  ...
  return jsonResponse({
    ...
    worker_name: WORKER_NAME,
    logical_app: LOGICAL_APP,
    route: "/api/main-board/dossier",
    final_board_row_id: finalId,
    selected: dossierRowToApi(selectedRaw),
    other_player_legs: legRows.map(rowToApi),
    raw_context: {
      details_json_snapshot: safeJsonParse(trimSnapshot(selectedRaw.details_json_snapshot || '')),
      prepared_row_payload_json: safeJsonParse(selectedRaw.prepared_row_payload_json),
      prepared_raw_source_json: safeJsonParse(selectedRaw.prepared_raw_source_json),
...
async function apiCurrent(env, url) {
  ...
  return jsonResponse({
    ...
    semantics: {
      ...
      rows_are: "Final Board V3 Shadow quota-selected Review Board candidates by default; add no_quotas=1 with the same query filters for full eligible inventory access.",
...
async function apiFilters(env) {
  ...
  const rows = await queryAllPg(pg, `
    SELECT
      ...
      CASE WHEN COALESCE(is_demon,0)=1 THEN 'demon' WHEN COALESCE(is_goblin,0)=1 THEN 'goblin' WHEN COALESCE(is_more_only,0)=1 THEN 'more_only' ELSE 'regular' END AS payout_variant,
      CASE WHEN COALESCE(is_goblin,0)=1 OR COALESCE(is_demon,0)=1 OR COALESCE(is_more_only,0)=1 THEN 'more_only' ELSE 'two_sided' END AS side_mode,
      COALESCE(is_goblin,0) AS is_goblin,
      COALESCE(is_demon,0) AS is_demon,
      CASE WHEN COALESCE(is_goblin,0)=0 AND COALESCE(is_demon,0)=0 AND COALESCE(is_more_only,0)=0 THEN 1 ELSE 0 END AS is_standard,
  ...
  const summaryRows = await queryAllPg(pg, `
    SELECT COUNT(*) AS total_rows, COUNT(*) AS default_rows,
      ...
      MIN(estimated_hit_probability_0_100) AS min_hp, MAX(estimated_hit_probability_0_100) AS max_hp,
...
async function apiHealth(env) {
  ...
  const dailyContextDates = "{" + (dailyContextWindowMode === "today" ? [todaysDate] : [tomorrowsDate].filter(Boolean)).join(",") + "}";
  ...
  function statusFor(coverageRatio, isFatal) {
    ...
    if (coverageRatio >= 0.9) return "green";
    if (coverageRatio >= 0.5) return "yellow";
    return "red";
  }
  ...
  const marketStageWorkers = [
    { label: "Market Certifier (market-certifier)", covered: Number(marketCertifierRows[0]?.n || 0), expected: null, unit: "slate summary rows", last_update: marketCertifierRows[0]?.last_update },
  ...
  const scoringStageWorkers = [
    ...
    { label: "Enrichment Engine (phase2a-run-environment)", covered: Number(enrichmentRows[0]?.n || 0), expected: null, unit: "legs enriched (excludes scoring-blocked legs)", last_update: enrichmentRows[0]?.last_update },
  ...
  const layers = [
    ...
    { key: "weekly_differential", label: "Weekly Differential", status: weeklyStatus, last_update: weeklyLastUpdate,
      metrics: [
        { label: "Teams", covered: Number(teamsRefRows[0]?.n || 0), expected: 30, unit: "teams" },
        { label: "Players", covered: Number(playersRefRows[0]?.n || 0), expected: null, unit: "players (roster)" },
        { label: "Stadiums", covered: Number(stadiumsRows[0]?.n || 0), expected: 30, unit: "stadiums" },
        { label: "Player Aliases", covered: Number(playerAliasRows[0]?.n || 0), expected: null, unit: "aliases" },
        { label: "Team Aliases", covered: Number(teamAliasRows[0]?.n || 0), expected: null, unit: "aliases" },
        { label: "Park Factors", covered: Number(parkRows[0]?.n || 0), expected: 30, unit: "parks" },
        { label: "Sprint Speed", covered: Number(sprintSpeedRows[0]?.n || 0), expected: null, unit: "players" },
        { label: "Quality of Contact", covered: Number(qocRows[0]?.n || 0), expected: null, unit: "players" },
        { label: "Batted Ball Profile", covered: Number(bbpRows[0]?.n || 0), expected: null, unit: "players" },
        { label: "Defensive Quality", covered: Number(defQualRows[0]?.n || 0), expected: null, unit: "players" },
        { label: "Catcher Framing", covered: Number(catcherFramingRows[0]?.n || 0), expected: null, unit: "catchers" },
        { label: "Pitcher Running Game", covered: Number(runningGameRows[0]?.n || 0), expected: null, unit: "pitchers" },
        { label: "Arm Angle", covered: Number(armAngleRows2[0]?.n || 0), expected: null, unit: "pitchers" },
        { label: "Pitcher Arsenal", covered: Number(pitcherArsenalRows[0]?.n || 0), expected: null, unit: "pitch types" },
      ],
    ...
    { key: "daily_context", label: "Daily Context", status: dailyContextStatus, last_update: dailyContextLastUpdate,
      ...
      window_note: dailyContextWindowMode === "today"
        ? `Scoped to today's ${dcTotalBoardGames} games (${todaysDate}), ${dcTeamsPlaying} teams. Lineups only post ~1-2 hours before first pitch, so 0 is expected until then; the derived/fallback lineup writer is currently disabled (DERIVED_BACKUP_WRITE_ENABLED=false in daily-lineups), so no automatic fallback fires if MLB is late posting - flag if lineups are still 0 within an hour of first pitch.`
        : `All of today's games (${todaysDate}) are underway or finished, so this has automatically rolled forward to tomorrow's ${dcTotalBoardGames} games (${tomorrowsDate}), ${dcTeamsPlaying} teams - that's the next actionable slate.`,
  ...
  return jsonResponse({
    ok: true, data_ok: true, version: VERSION, worker_name: WORKER_NAME, route: "/api/main-board/health", read_only: true,
    generated_at: nowUtc(), overall_status: overallStatus, total_board_players: totalBoardPlayers, total_board_games: totalBoardGames,
    layers,
  });
}
...
async function autoSelectBestLegs(env, options) {
  ...
  try {
    ...
    const distinctSourceKeys = [...new Set(rows.map(r => r.source_key))];
    const trustMapsBySource = new Map();
    for (const sk of distinctSourceKeys) {
      trustMapsBySource.set(sk, await computeLineTrustMultipliers(pg, sk));
    }
    ...
    for (const r of rows) {
      ...
      // final selection loop (sorted by the model's own score_0_100) would otherwise ignore.
      if (trust === 0) continue;
...
const GOBLIN_SLIP_MIN_CONFIDENCE = 70; // Lowered 2026-08-11 from 80: the 80 bar was calibrated
// against the pre-fix, inflated goblin population (rbis/walks/hits/total_bases/etc were wrongly
// labeled Goblin at 85-91% HP). Now that those correctly show as Demon instead, genuinely-correct
// goblins top out around 78-79% HP on a typical night - 70 matches the system's own PRIMARY-tier
// bar (estimated_hit_probability_0_100 >= 70) used everywhere else, so this tab reflects real
// data rather than going empty whenever the true goblin population is thinner than the old,
// bug-inflated one.
...
// UPDATED (2026-08-21, real placed-slip data): real observed today across three different
// sizes (3-pick=1.4x, 4-pick=1.5x, 5-pick=1.86x avg of 10 real observations) gave a remarkably
// consistent real per-leg rate (~1.12x/leg across all three). 2-pick and 6-pick are extrapolated
// from that same real rate since no real observation exists at those sizes yet - flagged
// separately from the confirmed 3/4/5-pick numbers. This REPLACES the old flat 3.5x/2.35x
// estimates, and is now the SINGLE source of truth for both the slip badge and the real-
...
// DEMON (High Hit track) — DISABLED AND REMOVED 2026-08-26. Two successive pools were tried here
// (a 5-prop/more/Tier1 pool locked 2026-08-22, then a pitcher_strikeouts/less/Tier2 replacement
// locked 2026-08-26) - both were fully removed after a comprehensive real, walk-forward,
// Gemini-adversarial-verified sweep found every Demon prop/side/tier1/tier2 combination in this
// system negative EV. See ALPHADOG_SESSION_LOG.md and ALPHADOG_REALIGNMENT.md Section 10 for the
// complete evidence. Do not re-add without new evidence that changes this conclusion.

async function autoSelectRegularHighHitSlipLegs(env) {
  const pg = pgClient(env);
  try {
    // LOCKED 2026-08-21: real, structurally-mispriced regular line (pitcher_fantasy_score/less) -
    // no lineup join needed, plain board query same shape as Goblin's.
    const rows = await queryAllPg(pg, `
...
async function autoSelectRegularHighHitSlipLegs_UNUSED_PLACEHOLDER_NEVER_MATCHES(env) {}
    ...
    return await queryAllPg(pg, `
      ...
      board AS (
        ...
        WHERE f.final_board_batch_id = (SELECT final_board_batch_id FROM score.final_board_batches WHERE finished_at IS NOT NULL ORDER BY finished_at DESC LIMIT 1)
          ...
          AND (CASE WHEN LOWER(f.selected_side) IN ('less','under','lower') THEN n.p_under ELSE n.p_over END) BETWEEN 0.05 AND 0.95
      ...
      FROM ranked
      WHERE board_pctl >= ${SL_PERCENTILE}
  ...
  for (const [sourceKey, sourceLegs] of bySource.entries()) {
    ...
    while (true) {
      ...
      allSlips.push({
        ...
        strategy_notes: [
          `Qualifying legs: TOP ${Math.round((1-BASELINE_HP_PERCENTILE)*100)}% of the day's board by BASELINE probability (classification.baseline_v6_current), Goblin only, excluding ${BASELINE_HP_EXCLUDED_PROPS.join('/')}. Percentile rather than a fixed cutoff because the baseline model was RESCALED on 2026-08-12 - the top 2% averaged 89.4 before and 96.2 after, while both hit ~98.9%. A hardcoded threshold breaks across a rescale; a percentile cannot. Selection bypasses the enriched board score, which separates winners from losers by only 4.8pp vs the baseline's 39.9pp.`,
          `The three excluded props were dropped on HIT RATE alone, no multiplier involved: hitter_strikeouts 80.95%, earned_runs 87.50%, fantasy_score 90.48%, against a field running 96-100%. Removing them lifts 6-pick full-hit from 85.2% to 90.4%, and the gain holds when scored with flat rates.`,
          `Backtest: 83 slips, 75 full hits (90.4%), 23 days, +120.8% ROI. 21 of 23 days profitable; ZERO slips ever finished 4/6 or worse. Bootstrap 100% positive, 95% CI [+100.9%, +136.6%], leave-one-out [+118.4%, +126.2%]. Validated across BOTH baseline model versions: +99.3% pre-rescale, +110.5% post.`,
          `⚠️ SUBSTITUTION DISCIPLINE: only swap in legs from the backup pool, which contains only legs that already passed this filter. On 2026-08-27, legs substituted from BELOW the threshold went 0-for-5 while the 19 qualifying legs went 19-for-19. A sub-threshold leg costs ~6-16 points of full-hit probability; the extra leg's multiplier adds only ~15%. If nothing qualifies, LET THE SLIP SHRINK.`,
...
async function apiHighHitSlips(env, request) {
  ...
  const udSlips = udSlipsAll.slice(0, slipsAffordable(udLegs.length, UD_SLIP_SIZE, UD_MAX_SLIPS_PER_DAY));
  ...
  const slBaselineSlips = slSlipsAll.slice(0, slipsAffordable(slLegs.length, SL_SLIP_SIZE, 99));
  ...
  // (Reserve helpers poolReserveFor / slipsAffordable are declared above, before the builders.)
  const backupPool = [
  ...
  return jsonResponse({
    ...
    notes: [
      `PrizePicks Goblin: percentile strategy, updated 2026-08-28. Legs = TOP ${Math.round((1-BASELINE_HP_PERCENTILE)*100)}% of the day's board by baseline probability, excluding ${BASELINE_HP_EXCLUDED_PROPS.join('/')}. Percentile rather than a fixed cutoff because the baseline was rescaled on 2026-08-12 (top 2% averaged 89.4 before, 96.2 after, both hitting ~98.9%) - a hardcoded threshold breaks across a rescale. Backtest: 83 slips, 75 full hits (90.4%), 23 days, +120.8% ROI, 21/23 days profitable, bootstrap 100% positive, CI [+100.9%, +136.6%]. Validated across both model versions (+99.3% pre-rescale, +110.5% post). ⚠️ Substitute ONLY from the backup pool - on 2026-08-27 sub-threshold substitutes went 0-for-5 while qualifying legs went 19-for-19. Always overwrite the prefilled multiplier with what the app actually shows.`,
      ...
      "Sleeper: PAUSED 2026-08-26 - real breakeven (78.84% at the confirmed 1.2684x per-leg multiplier) was not cleared by any of four separately Gemini-adversarial-verified signals (raw trailing hit rate, model probability, lineup-slot gradient, multi-layer combination). Best result across all combinations was 71.84%, still 7 points short. See ALPHADOG_SESSION_LOG.md for the full research.",
