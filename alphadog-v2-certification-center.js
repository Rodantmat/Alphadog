...
.slipSourceFilterRowNew{display:flex;gap:16px;align-items:center;margin:2px 0 14px;padding:9px 12px;background:rgba(5,14,26,.3);border:1px solid var(--line);border-radius:14px;font-size:12.5px;color:var(--muted)}.slipSourceFilterRowNew .filterLabel{font-size:10px;text-transform:uppercase;letter-spacing:.1em;font-weight:950;color:var(--muted);margin-right:2px}.slipSourceFilterRowNew label{display:flex;align-items:center;gap:6px;cursor:pointer;font-weight:800;color:var(--text)}.slipSourceFilterRowNew input{accent-color:var(--blue);width:15px;height:15px}
...
<div class="wrap">
  ...
  <section id="slipsScreen" class="hidden"><div class="panel"><button id="slipsBack" class="btn">← Main Board</button><h2 style="margin:12px 0 8px">Slip Builder</h2><div class="slipTabBar"><button id="autoCreateSlipsBtn" class="slipTab" data-tab="grounded"><span class="dot grounded"></span>Grounded Slips</button><button id="highHitSlipsBtn" class="slipTab" data-tab="highhit"><span class="dot goblin"></span>High Hit Slips</button><button id="goblinSlipsBtn" class="slipTab" data-tab="goblin"><span class="dot goblin"></span>Goblin Slips</button><button id="regularSlipsBtn" class="slipTab" data-tab="regular"><span class="dot regular"></span>Regular Slips</button><button id="demonSlipsBtn" class="slipTab" data-tab="demon"><span class="dot demon"></span>Demon Slips</button></div><div id="slipSourceFilterRow" class="slipSourceFilterRowNew hidden"><span class="filterLabel">Apps</span><label><input type="checkbox" id="filterSleeper" checked>Sleeper</label><label><input type="checkbox" id="filterPrizepicks" checked>PrizePicks</label><label><input type="checkbox" id="filterUnderdog" checked>Underdog</label></div><div id="autoCreateResults"></div></div></section>
