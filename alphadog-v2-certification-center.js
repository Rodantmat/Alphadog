...
<div class="wrap">
  ...
  <section id="slipsScreen" class="hidden"><div class="panel"><button id="slipsBack" class="btn">← Main Board</button><h2 style="margin:12px 0 8px">Slip Builder</h2><div class="slipTabBar"><button id="autoCreateSlipsBtn" class="slipTab" data-tab="grounded"><span class="dot grounded"></span>Grounded Slips</button><button id="goblinSlipsBtn" class="slipTab" data-tab="goblin"><span class="dot goblin"></span>Goblin Slips</button><button id="regularSlipsBtn" class="slipTab" data-tab="regular"><span class="dot regular"></span>Regular Slips</button><button id="demonSlipsBtn" class="slipTab" data-tab="demon"><span class="dot demon"></span>Demon Slips</button></div><div id="slipSourceFilterRow" class="slipSourceFilterRowNew hidden"><span class="filterLabel">Apps</span><label><input type="checkbox" id="filterSleeper" checked>Sleeper</label><label><input type="checkbox" id="filterPrizepicks" checked>PrizePicks</label><label><input type="checkbox" id="filterUnderdog" checked>Underdog</label></div><div id="autoCreateResults"></div></div></section>
