...
<div class="wrap">
  ...
  <section id="slipsScreen" class="hidden"><div class="panel"><button id="slipsBack" class="btn">← Main Board</button><button id="autoCreateSlipsBtn" class="btn" style="margin-bottom:10px">⚡ Grounded Slips</button><button id="goblinSlipsBtn" class="btn" style="margin-bottom:10px;margin-left:8px">🟢 Goblin Slips</button><button id="regularSlipsBtn" class="btn" style="margin-bottom:10px;margin-left:8px">⚪ Regular Slips</button><button id="demonSlipsBtn" class="btn" style="margin-bottom:10px;margin-left:8px">🔴 Demon Slips</button><div id="slipSourceFilterRow" style="display:flex;gap:14px;align-items:center;margin:4px 0 12px;font-size:13px;color:#9ab"><label style="display:flex;align-items:center;gap:5px;cursor:pointer"><input type="checkbox" id="filterSleeper" checked>Sleeper</label><label style="display:flex;align-items:center;gap:5px;cursor:pointer"><input type="checkbox" id="filterPrizepicks" checked>PrizePicks</label><label style="display:flex;align-items:center;gap:5px;cursor:pointer"><input type="checkbox" id="filterUnderdog" checked>Underdog</label></div><div id="autoCreateResults"></div></div></section>
