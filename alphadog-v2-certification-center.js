...
<div class="wrap">
  ...
  <section id="slipsScreen" class="hidden"><div class="panel"><button id="slipsBack" class="btn">← Main Board</button><button id="autoCreateSlipsBtn" class="btn" style="margin-bottom:10px">⚡ Grounded Slips</button><div id="autoCreateResults"></div></div></section>
