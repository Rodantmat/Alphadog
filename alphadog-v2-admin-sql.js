...
async function toolRunJob(env, args) {
  ...
  } else if (bindingName === "NBA_STATIC_TEAMS_WORKER" || bindingName === "NBA_STATIC_PLAYERS_WORKER" || bindingName === "NBA_STATIC_ARENAS_WORKER") {
