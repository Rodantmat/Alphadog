...
// ============================================================
// Hit Probability / Recent-Form Hit Rate Phase v0.1.5
// ============================================================
...
const HP_VERSION = "alphadog-v2-scoring-engine-v0.4.13-walks-less-low-frequency-route-fix";
const HP_PROFILE_VERSION = "HP_RECENT_FORM_V0_1_5_WALKS_LESS_ROUTE_LOCK";
...
const HP_LOW_FREQUENCY_LESS_PROP_KEYS = new Set(['rbis','home_runs','doubles','triples','walks']);
