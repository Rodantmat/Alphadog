...
const HP_VERSION = "alphadog-v2-scoring-engine-v0.4.12-recent-form-cap-route-balance-fix";
const HP_PROFILE_VERSION = "HP_RECENT_FORM_V0_1_4_CAP_ROUTE_BALANCED";
