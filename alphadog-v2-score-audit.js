...
const VERSION = "alphadog-v2-scoring-engine-v0.4.36-fast-hp-engine-tune";
...
async function runScoringEngineCurrent(env, input) {
  ...
  const chunk = await insertEngineCurrentProfileChunk(env, batchId, PRODUCTION_PROFILE_KEY, { readChunkSize: 80, writeBatchSize: 16, maxRowsThisInvocation: 420, maxMillis: 43000 });
  await run(env.SCORE_DB, `
    UPDATE scoring_engine_batches
  ...
  `,
    ...
    JSON.stringify(baseIdentity({
      ...
      chunked_current_scoring: true,
      scoring_soft_timebox_ms: 43000,
      max_rows_this_invocation: 420,
...
const HP_VERSION = "alphadog-v2-scoring-engine-v0.4.36-fast-hp-engine-tune-board";
const HP_PROFILE_VERSION = "HP_RECENT_FORM_V0_2_4_FAST_HP_ENGINE_TUNE";
