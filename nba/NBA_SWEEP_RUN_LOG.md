...
| **Exact next step for T9** | **Pass 3 = the two-direction judgment** (`scratchpad/t9/judge9.py`, already pointed at T9). **Then**: live numeric re-verification · novelty audit vs `/tmp/t9base/nba/` · referential integrity / composite key · self-contradiction audit · dated-verdict audit. **3 consecutive clean at 3 different angles closes it, judgment among them.** |
