...
| **Exact next step for T9** | **Pass 8 = a second two-direction judgment** (`scratchpad/t9/judge9.py`) — **required among the closing three**; judge §T9.19–§T9.22's claims under rules 12 and 14. Then **pass 9 = live numeric re-verification** (re-derive 206,237 / 3 asof days / 385 players / 22 props / 16,208 unresolvable / 15-15-20 dict populations, **summing every partition**), then **pass 10 = self-contradiction audit**. **3 consecutive clean at 3 different angles closes T9** → then **T10** (`2026-09-10-…`, next in `/home/claude/nbadoc/transcripts/`). |
