...
| **State** | **CLEAN 0/3 · 23 passes · ALL FOUR STRATA READ.** 🔴🔴 **Pass 23 proved pass 22's finding by executing the module** (2026-09-30 → `2025-26`; **2026-10-01 → `2026-27`**) and **dated it: six scheduled runs fall inside the window** — `nba-scrape.yml` and `nba-p1-weekly-static.yml`, Mondays **Oct 5 · Oct 12 · Oct 19**. `stats_seasons(3)` also silently drops `2023-24` that day. **OWNER DECISION O4.** |
