...
| **State** | **CLEAN 0/3 · 10 passes · ALL FOUR STRATA READ.** 1,081 segments (largest yet), 944 uncovered vs twelve (87.3%). Tail at `scratchpad/t7/t7_tail.json`. **Passes 9 and 10 each found defects — all of them in this sweep's own prose, none in the transcript.** The count went 2/3 → 0/3 at pass 9 and has not restarted. |
