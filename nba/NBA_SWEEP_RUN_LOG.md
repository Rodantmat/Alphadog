...
| **State** | **CLEAN 0/3 · 13 passes · ALL FOUR STRATA READ.** Pass 12 (referential integrity) was clean — **4 joins, 0 orphans** — then **pass 13 (judgment) found that pass 11's "new" finding was already §T2.18**, reset to 0/3. Coverage moved as the documents grew: uncovered vs twelve **944 → 932**. |
