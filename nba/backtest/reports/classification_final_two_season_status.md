...
FACTOR LAYER (v21, owner directive: in from the start, nothing forced). Static/derived opponent + pace + home + B2B factors, per-prop coefficients FIT ON TRAIN in log-rate space (centered features; beta~0 = unneeded). Fitted 2025-26 / 2024-25-holdout:
  points: pace 1.17 / -, opp DEF rating 0.53 / -, home 0.02, B2B 0.06 | rebounds: pace 0.66, opp miss rate 0.33, opp OREB -0.11, home 0.01, B2B 0.05
  blocks: pace 0.30 / 0.16, opp paint share 0.30 / 0.37, home 0.01, B2B 0.00 | steals: pace 0.23 / -0.03, opp TOV rate 0.27 / 0.26, home 0.00, B2B 0.00
  Opponent-profile coefficients are STABLE across seasons (transferable signal); pace is unstable with one training season; home and B2B are ~0 everywhere (the minutes model already carries B2B).
