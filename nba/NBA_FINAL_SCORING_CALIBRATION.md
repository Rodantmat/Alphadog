...
> 📏 **`327` sections · re-derived `2026-09-26` (pass 25, RUN)** *(was `274` on `2026-09-23`, `316` on `2026-09-25`, `322` after §T26.55; the last `+5` is §T26.66's; **`RULE 59` — re-derive AND RUN, never quote**):* `` grep -cE '^(> *)*#{1,6} ' nba/NBA_FINAL_SCORING_CALIBRATION.md ``
