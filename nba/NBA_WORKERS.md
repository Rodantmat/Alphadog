...
>
> 📏 **`191` sections · re-derived `2026-09-26` (pass 22)** *(was `130` on `2026-09-23`, `168` on `2026-09-25`; the `+23` is §T26.61's; **`RULE 59` — re-derive AND RUN, never quote**):* `` grep -cE '^(> *)*#{1,6} ' nba/NBA_WORKERS.md ``
