...
# leaguestandingsv3's real response (confirmed 2026-08-31, first successful live scrape) has no
# TeamAbbreviation/TeamCode column at all - every team came back with an empty abbreviation.
# Team IDs are NBA's own stable, decades-unchanged identifiers (independently verified against
# the certified static fallback in alphadog-v2-nba-static-teams.js - all 30 IDs matched exactly),
# so deriving the abbreviation from ID here is a safe, real mapping, not a guess.
