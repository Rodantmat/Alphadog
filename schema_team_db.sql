...
VALUES ('bullpen_history_v0_1_0_schema_source_lock_probe', 'alphadog-v2-base-bullpen-history-v0.1.0-schema-source-lock-probe', 'Additive bullpen history lifecycle schema for source-lock probe only; no live promotion, no delta, no daily bullpen availability');
