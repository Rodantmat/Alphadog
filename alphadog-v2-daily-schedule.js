...
function deriveSpot({ game, teamId, side, preparedRows, maps, sources, batchId, sourceSnapshotAt }) {
  ...
  return {
    row: {
      ...
      eastward_travel_flag: eastwardTravel,
      westward_travel_flag: westwardTravel,
