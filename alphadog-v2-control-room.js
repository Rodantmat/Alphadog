...
async function executeSql(request, env) {
  if (!requireAdmin(request, env)) return jsonResponse({ok:false, error:"admin_token_disabled_single_user_mode"}, 401);
