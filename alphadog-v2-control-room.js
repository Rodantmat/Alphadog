const SYSTEM_VERSION = "alphadog-v2-control-room-v1.6.6-repeat-full-delta-guard";
  ...
  if (job === "orchestrator_enqueue_delta_hitter_game_logs") {
    ...
    if (retainedDeltaGuard.pass) {
      return jsonResponse({
        ...
        note: "Blocked repeat full-refresh delta because a completed promoted retained-stage delta already exists. Build the true daily hybrid delta separately before pressing this button again."
      });
    }
