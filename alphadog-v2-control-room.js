  ...
  if (job === "orchestrator_enqueue_static_teams") {
    ...
    if (existing) {
      return jsonResponse({
        ...
        request_id: existing.request_id,
        existing,
        visible_button: "ORCHESTRATOR > Static Teams"
      });
    }
    ...
    ).bind(requestId, JSON.stringify({request_id:requestId, chain_id:chainId, visible_button:"ORCHESTRATOR > Static Teams"})).run();
