const SYSTEM_VERSION = "alphadog-v2-control-room-v1.6.198-v2-heb-all-current-input-wire";
...
async function v12OrchestratorLocalBridge(job, env, ctx = null) {
  ...
  if (job === "orchestrator_enqueue_expansion_baseline_v2_heb") {
    ...
    const input = {
      source:"control_room", visible_button:"EXPANSION > V2 HEB Baseline", mode:"baseline_v2_heb", expansion_mode:"baseline_v2_heb", v2_chunk_size:80, created_at:now,
      ...
      v2_source_mode:"all_hit_probability_v2_current", baseline_source_policy:"source_agnostic_unless_formula_profile_is_source_specific",
    ...
    ).bind(requestId, JSON.stringify({request_id:requestId, chain_id:chainId, visible_button:"EXPANSION > V2 HEB Baseline", queued_job_key:"expansion-baseline-v2", queued_worker_name:"alphadog-v2-phase3a-first-inning-pitcher-context", mode:"baseline_v2_heb", source_hp_v2_batch_id:"__ALL_HIT_PROBABILITY_V2_CURRENT__", read_all_hp_v2_current:true, v2_chunk_size:80, parallel_v2_only:true, no_current_baseline_mutation:true, backend_hot_continue_triggered:true})).run();
    if (ctx && typeof ctx.waitUntil === "function") {
