const SYSTEM_VERSION = "alphadog-v2-control-room-v1.5.31-autonomous-final-cleanup";
  ...
  if (job === "orchestrator_enqueue_base_hitter_game_logs") {
    ...
    if (existing) {
      if (ctx && typeof ctx.waitUntil === "function") {
        ctx.waitUntil(callOrchestrator("/pump", {
