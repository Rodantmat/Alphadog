const SYSTEM_VERSION = "alphadog-v2-control-room-v1.6.94-pitcher-splits-v0-5-6-labels";
...
async function v12OrchestratorLocalBridge(job, env, ctx = null) {
  ...
  if (job === "orchestrator_enqueue_delta_pitcher_splits") {
    ...
    const input = {
      ...
      created_at: now,
      worker_scope: "delta_noop_restore_scoped_repair_daily_affected_refresh_gate_v0_5_6",
