const SYSTEM_VERSION = "alphadog-v2-control-room-v1.6.208-baseline-v5-deployed-html-route-parity";
...
async function v12OrchestratorLocalBridge(job, env, ctx = null) {
  ...
  if (["orchestrator_enqueue_baseline_v5_classification_base","orchestrator_enqueue_baseline_v5_classification_delta","orchestrator_enqueue_baseline_v5_base","orchestrator_enqueue_baseline_v5_delta"].includes(job)) {
    const modeMap = {
    ...
    const input = {
      ...
      baseline_v5:true, baseline_v5_function:isClassification?"classification":"baseline", baseline_v5_run_type:isBase?"base":"delta",
      v2_chunk_size:isBase?160:80, v2_all_current_chunk_size:isBase?160:80, v2_soft_yield_ms:isBase?60000:45000,
