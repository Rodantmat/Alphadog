const SYSTEM_VERSION = "alphadog-v2-control-room-v1.6.211-baseline-base-rescue-button-parity";
...
async function v12OrchestratorLocalBridge(job, env, ctx = null) {
  ...
  if (["orchestrator_enqueue_baseline_v5_classification_base","orchestrator_enqueue_baseline_v5_classification_rescue","orchestrator_enqueue_baseline_v5_classification_delta","orchestrator_enqueue_baseline_v5_base","orchestrator_enqueue_baseline_v5_base_rescue","orchestrator_enqueue_baseline_v5_delta"].includes(job)) {
    const modeMap = {
    ...
    const labelMap = {
      ...
      baseline_v5_classification_delta: "FINAL SCORING SYSTEM > Classification Delta",
      baseline_v5_base: "FINAL SCORING SYSTEM > Baseline Base",
      baseline_v5_base_rescue: "FINAL SCORING SYSTEM > Baseline Base Rescue",
      baseline_v5_delta: "FINAL SCORING SYSTEM > Baseline Delta"
    };
    ...
    const input = {
      ...
      baseline_v5:true, baseline_v5_function:isClassification?"classification":"baseline", baseline_v5_run_type:isBaseRescue?"base_rescue":(isRescue?"rescue":(isBase?"base":"delta")),
      ...
      no_prizepicks:true, no_sleeper:true, no_scoring:true, no_final_board:true, no_scheduler_mutation:true, no_current_baseline_mutation:!isBaseRescue, targeted_current_baseline_mutation:isBaseRescue,
