const SYSTEM_VERSION = "alphadog-v2-control-room-v1.5.10-static-players-button";
...
async function v12OrchestratorLocalBridge(job, env) {
  ...
  if (job === "orchestrator_enqueue_static_players") {
    ...
    ).bind(requestId, JSON.stringify({request_id:requestId, chain_id:chainId, visible_button:"STATIC > Players"})).run();
