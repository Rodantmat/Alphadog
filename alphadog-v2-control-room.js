const SYSTEM_VERSION = "alphadog-v2-control-room-v1.6.199-v2-heb-fast-safe-input-wire";
...
async function v12OrchestratorLocalBridge(job, env, ctx = null) {
  ...
  if (job === "orchestrator_enqueue_expansion_baseline_v2_heb") {
    ...
    const input = {
      source:"control_room", visible_button:"EXPANSION > V2 HEB Baseline", mode:"baseline_v2_heb", expansion_mode:"baseline_v2_heb", v2_chunk_size:48, v2_all_current_chunk_size:48, v2_soft_yield_ms:45000, created_at:now,
      ...
      v2_source_mode:"all_hit_probability_v2_current", fast_safe_chunk_policy:"all_current_default_48_cap_64_soft_yield_45s", baseline_source_policy:"source_agnostic_unless_formula_profile_is_source_specific",
    ...
    ).bind(requestId, JSON.stringify({request_id:requestId, chain_id:chainId, visible_button:"EXPANSION > V2 HEB Baseline", queued_job_key:"expansion-baseline-v2", queued_worker_name:"alphadog-v2-phase3a-first-inning-pitcher-context", mode:"baseline_v2_heb", source_hp_v2_batch_id:"__ALL_HIT_PROBABILITY_V2_CURRENT__", read_all_hp_v2_current:true, v2_chunk_size:48, v2_all_current_chunk_size:48, v2_soft_yield_ms:45000, fast_safe_chunk_policy:"all_current_default_48_cap_64_soft_yield_45s", parallel_v2_only:true, no_current_baseline_mutation:true, backend_hot_continue_triggered:true})).run();
    if (ctx && typeof ctx.waitUntil === "function") {
    ...
    return jsonResponse({ ok:true, data_ok:true, version, job, status:"queued", request_id:requestId, chain_id:chainId, visible_button:"EXPANSION > V2 HEB Baseline", queued_job_key:"expansion-baseline-v2", queued_worker_name:"alphadog-v2-phase3a-first-inning-pitcher-context", mode:"baseline_v2_heb", v2_chunk_size:48, v2_all_current_chunk_size:48, v2_soft_yield_ms:45000, parallel_v2_only:true, no_current_baseline_mutation:true, auto_pump_triggered:true, browser_auto_pump:false, source_hp_v2_batch_id:"__ALL_HIT_PROBABILITY_V2_CURRENT__", read_all_hp_v2_current:true, fast_safe_chunk_policy:"all_current_default_48_cap_64_soft_yield_45s", note:"Queued all-current parallel V2 HEB baseline. Backend hot pump/watchdog was launched; manual Wake is rescue only." });
  }
