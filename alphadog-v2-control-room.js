const SYSTEM_VERSION = "alphadog-v2-control-room-v1.6.77-clear-labels-original-layout";
...
<!-- alphadog-v2-control-room-v1.6.77-clear-labels-original-layout -->
<style>
...
<div id=\"versionTag\">alphadog-v2-control-room-v1.6.77-clear-labels-original-layout</div>
...
<button class=\"orch\" type=\"button\" onclick=\"runJobButton('BASE > Hitter Metrics Snapshot Prep','orchestrator_enqueue_base_hitter_metrics')\">Hitter Metrics</button>
...
<button class=\"orch\" type=\"button\" onclick=\"runJobButton('DELTA > Hitter Metrics Live Repair','orchestrator_enqueue_delta_hitter_metrics')\">Hitter Metrics Repair</button>
...
function debugConfig(){
  setOutput(\"DEBUG > Config\",{base:BASE,auto_slate:autoSlateContext(),access_mode:\"single-user-admin-token-disabled\", orchestrator_mode:\"backend-scheduled-continuation\",wake_binding_required:\"ORCHESTRATOR_WORKER -> alphadog-v2-orchestrator\",public_url_fallback_disabled:true,version:\"alphadog-v2-control-room-v1.6.77-clear-labels-original-layout\", visible_hitter_metrics_button_required:true, hitter_metrics_route:\"orchestrator_enqueue_base_hitter_metrics\", ui_sentinel:\"CLEAR_LABELS_ORIGINAL_LAYOUT_V1_6_77\", hitter_metrics_mode:\"snapshot_delta_gate_repair_ready\"});
}
