const SYSTEM_VERSION = "alphadog-v2-control-room-v1.6.210-baseline-v5-rescue-allowlist-parity";
...
async function v12OrchestratorLocalBridge(job, env, ctx = null) {
  ...
  if (["orchestrator_enqueue_baseline_v5_classification_base","orchestrator_enqueue_baseline_v5_classification_rescue","orchestrator_enqueue_baseline_v5_classification_delta","orchestrator_enqueue_baseline_v5_base","orchestrator_enqueue_baseline_v5_delta"].includes(job)) {
    const modeMap = {
    ...
    const isRescue = mode === "baseline_v5_classification_rescue";
    ...
    const input = {
      ...
      baseline_v5:true, baseline_v5_function:isClassification?"classification":"baseline", baseline_v5_run_type:isRescue?"rescue":(isBase?"base":"delta"),
      ...
      no_prizepicks:true, no_sleeper:true, no_scoring:true, no_final_board:true, no_scheduler_mutation:true,
