const SYSTEM_VERSION = "alphadog-v2-control-room-v0.5";
const CONTROL_ROOM_HTML = "<!DOCTYPE html>
<html>
<head>
<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">
<title>AlphaDog V2 Control Room</title>
<!-- alphadog-v2-control-room-v0.5 - embedded compact phone UI -->
<style>
...
<div id=\"versionTag\">alphadog-v2-control-room-v0.5</div>
...
function debugConfig(){setOutput(\"DEBUG > Config\",{base:BASE,config_url:CONFIG_URL,auto_slate:autoSlateContext(),token_set:Boolean(TOKEN),config_loaded:CONFIG_LOADED,token_fingerprint:tokenFingerprint(),version:\"alphadog-v2-control-room-v0.5\"})}
