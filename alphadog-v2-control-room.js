const SYSTEM_VERSION = "alphadog-v2-control-room-v1.5.11-static-players-auto-pump";
  ...
  if (job === "orchestrator_enqueue_static_players") {
    ...
    if (existing) {
      if (ctx && typeof ctx.waitUntil === "function") {
        ctx.waitUntil(callOrchestrator(env, "/pump", {source:"control_room_static_players_existing_auto_pump", request_id:existing.request_id, max_cycles:12, max_jobs_per_cycle:2, max_ms:25000}));
      }
      return jsonResponse({
        ok: true,
        data_ok: true,
    ...
    if (ctx && typeof ctx.waitUntil === "function") {
      ctx.waitUntil(callOrchestrator(env, "/pump", {source:"control_room_static_players_enqueue_auto_pump", request_id:requestId, max_cycles:12, max_jobs_per_cycle:2, max_ms:25000}));
    }
